                  ...
                  >
                    ...
                    <AnimatePresence>
                      {activeDropdown === item.label && (
                        ...
                        >
                          <div className="bg-white rounded-2xl py-2 border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.08)]">
                                ...
                                <Link
                                  ...
                                  className={`block px-5 py-2.5 text-sm transition-all duration-150 font-medium whitespace-nowrap ${
                                    isChildActive
                                      ...
                                      : "text-gray-900 hover:bg-sky-50 hover:text-primary"
                                  }`}
                                >
                                  {child.label}
                                </Link>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-x-0 top-header-h bottom-0 z-30 bg-white border-t border-slate-100 lg:hidden overflow-y-auto"
          >
              ...
              {NAV_ITEMS.map((item) => {
                ...
                return (
                  <Link
                    key={item.label}
                    href={item.href}
                    className={`block text-base font-bold border-b border-slate-100 pb-4 transition-colors ${
