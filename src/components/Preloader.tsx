    ...
    <AnimatePresence>
      {!isLoaded && (
        ...
        >
          ...
          {/* Radial mask */}
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_70%_70%_at_50%_50%,transparent_40%,#010C1E_100%)] pointer-events-none" />

          {/* Glow circle */}
          <div className="absolute w-[360px] h-[360px] md:w-[480px] md:h-[480px] rounded-full bg-[radial-gradient(circle,rgba(0,170,223,0.15)_0%,transparent_70%)] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-pulse pointer-events-none" />
          ...
          <div className="relative flex flex-col items-center gap-8">
            ...
            <div className="relative w-28 h-28 md:w-32 md:h-32">
              ...
              {/* Middle Dashed Ring */}
              <div 
                className="absolute inset-[-6px] rounded-full border-1.5 border-dashed border-primary/15"
            ...
            <div className="w-56 flex flex-col items-center gap-2">
              <div className="w-full h-1 bg-white/5 rounded-full overflow-hidden">
                <div 
                  className="h-full bg-gradient-to-r from-primary-600 via-primary to-accent-light rounded-full transition-all duration-150 ease-out shadow-[0_0_10px_rgba(0,170,223,0.8)]"
                  style={{ width: `${progress}%` }}
                />
              </div>
              <div className="w-full flex justify-end">
                <span className="text-[10px] text-primary/45 font-mono">
                  {Math.round(progress)}%
                </span>
              </div>
            </div>
