...
export default function PortfolioPage() {
  const projects = [
    { title: "GTA Grizzly Contracting", category: "Contracting & Construction", tags: ["Web Design", "Local SEO"], year: "2025" },
    { title: "TCM Wellness Brampton", category: "Healthcare & Clinic", tags: ["Web Design", "Patient Portal"], year: "2025" },
    { title: "Remove My Walls Inc", category: "Home Renovation Services", tags: ["SEO Overhaul", "UX/UI Rebuild"], year: "2024" },
    { title: "Canadian Bitcoin Exchange", category: "Fintech & Finance", tags: ["Web App", "Custom Integration"], year: "2024" },
    { title: "Zurva Logistics", category: "Supply Chain & B2B", tags: ["Corporate Site", "Consultancy"], year: "2024" },
    { title: "Amass Market Online", category: "E-Commerce & Retail", tags: ["Shopify Integration", "SEO positioning"], year: "2023" },
  ];
      ...
      <main className="pt-header-h min-h-screen bg-white">
        ...
        <section className="bg-dark text-white py-16 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black mb-4">Recent Portfolio</h1>
            <p className="text-white/60 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
              Explore how we have helped Canadian businesses establish robust, high-performance virtual storefronts.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 max-w-[1280px] mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((proj, idx) => (
              ...
              >
                {/* Mock Thumbnail Image placeholder using a beautiful gradient */}
                <div className="aspect-[16/10] bg-gradient-to-tr from-dark-blue to-[#0A2040] relative flex items-center justify-center p-6 overflow-hidden">
                  ...
                  <div className="relative z-10 flex flex-col items-center gap-3 text-white/40 group-hover:text-primary transition-colors">
                    ...
                    <span className="text-[10px] uppercase font-bold tracking-[0.2em]">CWD Project</span>
                  </div>
                </div>
